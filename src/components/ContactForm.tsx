...
export function ContactForm() {
  ...
  `w-full px-4 py-3.5 rounded-xl bg-dark-700 border ${errors[f] ? 'border-red-500' : 'border-[rgba(255,255,255,0.07)]'} text-white placeholder-[#333] font-inter text-sm focus:outline-none focus:border-[rgba(255,90,0,0.45)] focus:bg-[rgba(255,90,0,0.025)] transition-all duration-300`;
  return (
    <section
      ref={ref}
          ...
          <form onSubmit={submit} className="space-y-5" noValidate>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  className={`${inputCls('service')} appearance-none`}>
